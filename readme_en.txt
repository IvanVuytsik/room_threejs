We have 2 json files: one describes images of rooms in 3d tour (1.json), 
the second gives geometry of rooms in 2d space, top view (2.json).

The task is to build scene in three.js according to rooms from json file. 
The second task is to apply images on the inner sides of room walls.
